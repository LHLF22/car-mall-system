 ...
 * @LastEditTime: 2024-03-10 22:18:52
 * @FilePath: \car-mall-system\src\views\seller\AfterSale.vue
 * @Description: 
-->
<template>
  <div>
    <el-table
      row-key="date"
      :data="sellerLayoutStore.afterSaleTable"
      style="width: 100%"
    >
      ...
      <el-table-column
        ...
        :filters="
          Array.from(
            new Set(
              sellerLayoutStore.afterSaleTable.map((e) => e.afterSaleType)
            )
...
sellerLayoutStore.getAfterSale();
